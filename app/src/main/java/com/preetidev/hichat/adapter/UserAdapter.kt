...
class UserAdapter(private val context: Context,  listOfUsers: MutableList<Users>) : RecyclerView.Adapter<UserHolder>() {
...
interface OnItemClickListener{
    ...
    //abstract fun onChatSelected(position: Int, chat: RecentChats)
}