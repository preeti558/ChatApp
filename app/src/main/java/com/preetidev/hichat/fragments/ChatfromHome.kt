...
import com.preetidev.hichat.adapter.MessageAdapter
import com.preetidev.hichat.databinding.FragmentChatfromhomeBinding
...
class ChatfromHome : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_chatfromhome, container, false)
